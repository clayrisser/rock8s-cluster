 ...
 * File: /main.tf
 * Project: node_groups
 * File Created: 22-04-2022 05:23:55
 * Author: Terraform AWS Modules
 * -----
 * Last Modified: 22-04-2022 07:42:30
...
module "eks_managed_node_group" {
  ...
  cluster_endpoint                       = try(var.cluster_endpoint, "")
  cluster_auth_base64                    = try(var.cluster_certificate_authority_data, "")
  ...
  cluster_primary_security_group_id      = try(each.value.attach_cluster_primary_security_group, var.eks_managed_node_group_defaults.attach_cluster_primary_security_group, false) ? var.cluster_primary_security_group_id : null
